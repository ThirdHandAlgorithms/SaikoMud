...
TJRURI::TJRURI( TJRLookupBase *pLookupBase ) : TGFFreeable() {
...
void TJRURI::parseUri( const TGFString *sUri, bool bClearVars ) {
   TGFString *sTmp1 = new TGFString();
   TGFString *sTmp2 = new TGFString();
   TGFString *sTmp3 = new TGFString();

   sTmp1->setValue( sUri );
   TJRLookupObject *objLookup;
...
void TJRURI::parseUri( const char *sUri, bool bClearVars ) {
   TGFString *s = new TGFString( sUri );
   parseUri( s, bClearVars );
   delete s;
}

TGFString *TJRURI::getUri() {
   TGFString *sUri = new TGFString();
